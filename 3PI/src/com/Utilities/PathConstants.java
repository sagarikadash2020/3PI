...
public class PathConstants {
    ...
    public static final String reportPath = System.getProperty("user.dir") + fs + "ExecutionReports" + fs;

    // Driver path location
    public static final String chromeDriverPath = System.getProperty("user.dir") + fs +"configuration" + fs
                                    + "chromedriver.exe";
